...
export default function TermsOfService() {
  return (
    <div className="document-previewer-wrapper-bd1724 max-w-screen-lg mx-auto">
      <div data-custom-class="body">
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div className="question">New York</div>,{" "}
            ...
            at <div className="question">141 Joralemon st</div>
            <div className="block-component" />,{" "}
            <div className="question">Apt 4B</div>
            <span
              style={{
                fontSize: "11.0pt",
                lineHeight: "115%",
            ...
            , <div className="question">Brooklyn</div>
                ...
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <div className="block-component" />
                      <div className="block-component" />,{" "}
                      <div className="question">NY</div>
                      <div className="statement-end-if-in-editor" />
                      <div className="block-component" />
                      <div className="block-component" />{" "}
                      <div className="question">11201</div>
                      <div className="statement-end-if-in-editor" />
                    </span>
                  </span>
                </span>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                <div className="question">
                  <a
                    href="http://www.block-spot.com"
                    target="_blank"
                    data-custom-class="link" rel="noreferrer"
                  >
                    http://www.block-spot.com
                  </a>
                </div>
              </span>{" "}
          ...
          >
            ...
            >
              You can contact us by <div className="block-component" />
              phone at <div className="question">7035073135</div>, email at{" "}
              <div className="question">noah@block-spot.com</div>
              <div className="block-component" />,
              <div className="statement-end-if-in-editor" /> or by mail to{" "}
              <div className="question">141 Joralemon st</div>
              <div className="block-component" />,{" "}
              <div className="question">Apt 4B</div>
              <div className="statement-end-if-in-editor" />,{" "}
              <div className="question">Brooklyn</div>
          ...
          >
            ...
            >
              ...
              <div className="statement-end-if-in-editor" />
              ), and <div className="question">BlockSpot LLC</div>, concerning your
          ...
          >
            ...
            >
              ...
              <div className="question">privacy@block-spot.com</div>, as stated in
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#license">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">
                  9. CONTRIBUTION <div className="block-component" />
                  LICENSE
                  <div className="statement-end-if-in-editor" />
                </span>
              </span>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              laws) and treaties
              <div className="block-component" /> in the United States and
              <div className="statement-end-if-in-editor" /> around the world.
            </span>
          </div>
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <br />
          ...
          >
            ...
            >
              ...
              <div className="question">noah@block-spot.com</div>. If we ever grant
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              <div className="block-component" /> through any part of the Services
          ...
          <ul>
            ...
            >
              <span style={{ fontSize: 15 }}>
                ...
                <div className="block-component" /> are original to you or that you
                have the necessary rights and <div className="block-component" />
                licenses
                <div className="statement-end-if-in-editor" /> to submit such
                Submissions
                <div className="block-component" /> and that you have full authority
            ...
            >
              <span style={{ fontSize: 15 }}>
                ...
                <div className="block-component" /> do not constitute confidential
                information.
              </span>
            </li>
          </ul>
          ...
          >
            ...
            <div className="block-component" /> and you expressly agree to reimburse
        ...
        <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
          ...
          >
            <span style={{ fontSize: 15 }}>
              We offer a <div className="question">30</div>-day free trial to new
                          ...
                          >
                            <div data-type="conditional-block">
                              ...
                              >
                                ...
                                content.
                                <div className="block-component" /> We may provide
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="block-component" /> following the terms of the
                Privacy Policy
                <div className="statement-end-if-in-editor" /> and your choices
                (including settings).
              </span>
            </span>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="block-component" />
            <div className="block-component" />. If you access the Services from any
            ...
            <div className="block-component" />, then through your continued use of
            ...
            <div className="block-component" />.<div className="block-component" />
            <div
              className="block-container if"
              data-type="if"
        ...
        >
          ...
          >
            ...
            Services.
            <div className="block-component" /> We will not be liable to you or any
        ...
        >
          <span style={{ fontSize: 15 }}>
            ...
            (collectively, the <div className="block-component" />
            "Parties" and individually, a "Party"
            <div className="statement-end-if-in-editor" />) shall be commenced or
            prosecuted in the
            <div className="block-component" /> state and federal courts
            <div className="statement-end-if-in-editor" /> located in
            <div className="block-component" />{" "}
            <div className="question">Newark</div>,
            <div className="statement-end-if-in-editor" />{" "}
            <div className="block-component" />
            <div className="question">Delaware</div>
            <div className="statement-end-if-in-editor" />, and the Parties hereby
            consent to, and waive all <div className="block-component" />
            defenses
            ...
            excluded from these Legal Terms. <div className="block-component" />
            ...
            <div className="question">one (1)</div> years after the cause of action
            arose.
          </span>
          <div className="statement-end-if-in-editor">
            <span style={{ fontSize: 15 }} />
        ...
        >
          ...
          >
            ...
            <div className="block-component" />
            defenses
            <div className="statement-end-if-in-editor" /> you may have based on the
            ...
            <strong>
              <strong>
                ...
                >
                  <strong>
                    <div className="block-component" />
                    Phone: <div className="question">7035073135</div>
                    <div className="statement-end-if-in-editor" />
                  </strong>
                </span>
              </strong>
