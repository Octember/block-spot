export default function PrivacyPolicy() {
  return (
    <div className="max-w-screen-lg mx-auto p-4 flex flex-col gap-4">
      ...
      <p>
        At block-spot.com, accessible from block-spot.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        block-spot.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in block-spot.com. This policy is not applicable
        ...
        <a href="https://checkbytools.com/">Privacy Policy Generator</a>.
      </p>
      ...
      <p>
        block-spot.com follows a standard procedure of using log files. These
      ...
      <p>
        block-spot.com&apos;s Privacy Policy does not apply to other advertisers
      ...
      <p>
        block-spot.com does not knowingly collect any Personal Identifiable
