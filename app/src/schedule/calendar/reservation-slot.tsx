import { Bars3Icon, ChevronDownIcon, EllipsisHorizontalIcon, PencilSquareIcon, TrashIcon } from '@heroicons/react/20/solid';
import { format } from 'date-fns';
import { Reservation } from 'wasp/entities';
import { Menu, MenuButton, MenuItem, MenuItems, PopoverButton, PopoverPanel } from '@headlessui/react'
  ...
  return <li className="relative mt-px flex" style={{
    ...
    >
      <div className="flex flex-row justify-between">
        <p className="font-semibold text-blue-700">{reservation.description}</p>

        <Popover className="relative">
          <PopoverButton>
            <EllipsisHorizontalIcon aria-hidden="true" className="-mr-1 size-5 text-gray-400 group-hover:text-blue-700" />
          </PopoverButton>
